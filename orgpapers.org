...
is already done in ~_config/use-org-contrib.el~ file (which is
sym-linked to ~_activated/use-org-contrib.el~).

The operative part in this file is the following:
