...
use it, git clone this repository, and move vikas.org to
...
Following code in vikas.org enables Org to run different types of
code. If you have installed vikas.org as specified in [[Customising
...
is already done for you if you have loaded vikas.org. 

The operative part in vikas.org is the following:
...
In vikas.org, the package biblatex is loaded with following options:
...
document, you can remove this line from vikas.org, and add the
...
vikas.org. You may need to install BibTex2html separately to make it
work.
...
including in vikas.org but is commented out. If you wish to use it,
...
following line in vikas.org sets the margins. You can tweak this to
