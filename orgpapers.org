...
Most of my remaining customisations are kept in the file
[[https://github.com/vikasrawal/orgpaper/blob/master/vikas-preferences.el][vikas-preferences.el]]. You can download it and save it in
~/.emacs.d/personal/ .
