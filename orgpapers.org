...
I also recommend using vikas-general.org, provided with this
repository. To use it, create a directory with your username under
~/.emacs.d/, git clone this repository, and move vikas-general.org to
this directory the directory with your name that you have just
created. 
