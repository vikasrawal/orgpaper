...
used repeatedly by using a short keyword preceded by ~<~. If you have
cloned my emacs configuration, a whole bunch of snippets would be in
...
use bibtex, biblatex or csl-based
