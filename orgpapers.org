...
used to overcome this limitation while exporting to LaTeX or HTML.
...
Three additional hacks are required for using these environments in orgmode.
...
#+BEGIN_SRC org :results replace drawer
  ...
  ,#+ATTR_LATEX: :align width=0.8\textwidth,colspec={l*{2}{S[table-format=3.1,table-alignment-mode=marker]}}
